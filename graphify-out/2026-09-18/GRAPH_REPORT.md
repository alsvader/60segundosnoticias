...
## Corpus Check
- 497 files · ~648,759 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3587 nodes · 5005 edges · 267 communities (217 shown, 47 thin omitted)
...
7. `server-only` - 20 edges
8. `getCategoryUrl()` - 20 edges
9. `Post` - 20 edges
10. `seedBaseFixtures()` - 20 edges
...
## Communities (267 total, 47 thin omitted)
...
Cohesion: 0.21
Nodes (12): inter, oswald, dynamic, FrontendLayout(), metadata, DraftModeBanner(), isSafeExternalUrl(), LinkLike (+4 more)
...
Cohesion: 0.10
Nodes (16): @payloadcms/richtext-lexical, CalloutBlock, EmbedBlock, GalleryBlock, ImageBlock, QuoteBlock, VideoBlock, CTA (+8 more)
...
Cohesion: 0.13
Nodes (20): ArticleCardData Contract (decoupled from Payload Post), CategoryHeader(), CategoryHeaderData, CategoryHeaderProps, CategoryBadge(), CategoryBadgeProps, categoryBadgeVariants, CategoryCard() (+12 more)

### Community 20 - "home-block-renderer.tsx"
Cohesion: 0.06
Nodes (38): cn, @vidstack/react, VideoPlayer(), VideoPlayerProps, SectionHeader(), SectionHeaderProps, Container(), ContainerProps (+30 more)
...
### Community 25 - "[post]/page.tsx"
Cohesion: 0.13
Nodes (29): ArticlePage(), ArticlePageProps, generateMetadata(), loadPost, generateMetadata(), HomePage(), loadHome, getArticleSidebar() (+21 more)
...
Cohesion: 0.18
Nodes (14): buildPreviewUrl(), generateHomePreviewURL(), generatePagePreviewURL(), generatePostPreviewURL(), isAdminOrWriter(), Posts, enforceAuthor(), assignPublishedAt() (+6 more)
...
### Community 43 - "dokploy-deploy.ts"
Cohesion: 0.08
Nodes (39): appendStepSummary(), assertDeployRequestNeverSendsFreshVolumes(), buildFailureMessage(), DEPLOYMENT_ID_CANDIDATE_FIELDS, DOKPLOY_DONE_STATUSES, DOKPLOY_ERROR_STATUSES, dokployApiCall(), extractComposeStatus() (+31 more)
...
Cohesion: 0.13
Nodes (26): next, generateMetadata(), getResolvedRootSlug, RootSlugPage(), RootSlugPageProps, robots(), applyStoredRedirect(), createHistoricalRedirect() (+18 more)
...
### Community 119 - "react"
Cohesion: 0.10
Nodes (18): class-variance-authority, radix-ui, react, @testing-library/user-event, ErrorBoundaryProps, Header(), HeaderProps, HeaderSearch() (+10 more)

### Community 120 - "mapMediaToMediaData"
Cohesion: 0.15
Nodes (21): formatLongDate(), formatShortDate(), LONG_DATE_FORMATTER, SHORT_DATE_FORMATTER, getPostUrl(), mapPostToArticleCardData(), MapPostToArticleCardDataOptions, mapPostToArticleDetailData() (+13 more)
...
Cohesion: 0.14
Nodes (26): InvalidateCategoryArgs, invalidateHome(), invalidatePage(), InvalidatePageArgs, invalidatePost(), InvalidatePostArgs, InvalidateSettingsArgs, revalidateKeyedTags() (+18 more)
...
Cohesion: 0.22
Nodes (19): CategoryCardData, getLatestPosts(), getPostsByCategory(), isPopulated(), RawHomeBlock, resolveBanner(), resolveBlock(), resolveCategoryExplorer() (+11 more)
...
Cohesion: 0.10
Nodes (22): sharp, GET, OPTIONS, POST, anyone(), isAdmin(), isAdminFieldAccess(), isLoggedIn() (+14 more)
...
Cohesion: 0.22
Nodes (12): lucide-react, AuthorCard(), AuthorCardProps, PLATFORM_ICONS, ShareActionsProps, FacebookLogo(), IconProps, InstagramLogo() (+4 more)
...
Cohesion: 0.09
Nodes (42): server-only, GET(), dynamic, getSitemapEntries, sitemap(), CACHE_TAGS, GetArticleSidebarPostsArgs, MODE_LABELS (+34 more)
...
Cohesion: 0.11
Nodes (17): LexicalRenderer(), ResponsiveMedia(), ResponsiveMediaProps, CTASection(), CTASectionProps, ImageTextSection(), ImageTextSectionProps, PageBlockRenderer() (+9 more)
...
### Community 202 - "accessibility-foundation spec (archived)"
Cohesion: 0.18
...
Cohesion: 0.18
Nodes (6): @testing-library/react, vitest, ShareActions(), createFakeRedirectsPayload(), FakeRedirect, matchesWhere()
...
### Community 235 - "media-storage.ts"
Cohesion: 0.20
Nodes (7): @payloadcms/storage-s3, zod, payloadEnv, payloadEnvSchema, DISABLED_S3_PLACEHOLDER, mediaStoragePlugins, s3Configured

### Community 236 - "resolve-root-slug.ts"
Cohesion: 0.26
Nodes (10): ResolvedRootSlug, resolveRootSlug(), ResolveRootSlugOptions, ActiveRedirect, findActiveRedirectByPath(), getPayload(), currentPreviewUser(), findDraftPageBySlug() (+2 more)
...
### Community 256 - "Post"
Cohesion: 0.19
Nodes (13): GET(), canViewDraftRevision(), extractUserId(), PreviewUser, MinimalPost, ALLOWED_PREVIEW_COLLECTIONS, ResolvedPreviewDocument, resolvePreviewDocument() (+5 more)

### Community 257 - "lexical-text.ts"
Cohesion: 0.24
...
Cohesion: 0.13
Nodes (14): Backups, Bitácora de despliegues, Bitácora de restauración, Cómo ejecutar un rollback, Cómo leer una falla, Cómo llega una release a producción, Despliegue, Drill de restauración (+6 more)
...
## Knowledge Gaps
- **1790 isolated node(s):** `$schema`, `style`, `rsc`, `tsx`, `config` (+1785 more)
...
- **Why does `payload` connect `payload` to `invalidate.ts`, `lexical-text.ts`, `dev.ts`, `package.json`, `(payload)/layout.tsx`, `Pages.ts`, `category-badge.tsx`, `payload.config.ts`, `Categories.ts`, `Posts.ts`, `get-test-payload.ts`, `getTestPayload`, `build-search-doc.ts`, `posts.ts`, `shell/cache-invalidation.ts`, `[category]/page.tsx`, `builders.ts`, `vitest`, `media-storage.ts`, `resolve-root-slug.ts`?**
...
- **Why does `vitest` connect `vitest` to `Post`, `getTestPayload`, `get-test-payload.ts`, `[category]/page.tsx`, `(frontend)/layout.tsx`, `package.json`, `embed-block.tsx`, `build-search-doc.ts`, `dokploy-deploy.ts`, `posts.ts`, `env/index.ts`, `react`, `[post]/page.tsx`?**
