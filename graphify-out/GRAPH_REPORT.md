...
## Corpus Check
- 105 files · ~70,086 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 657 nodes · 780 edges · 51 communities (40 shown, 7 thin omitted)
...
Cohesion: 0.10
Nodes (20): name, private, type, version, eslint, graphql, lucide-react, @payloadcms/next (+12 more)
...
Cohesion: 0.06
Nodes (41): payload, @payloadcms/richtext-lexical, sharp, GET, OPTIONS, POST, CATEGORY_ICON_KEYS, CategoryIconKey (+33 more)
...
Cohesion: 0.11
Nodes (18): ADDED Requirements, Purpose, Requirement: Aplicación server-side, no solo ocultamiento de UI, Requirement: Bloqueo de login para cuentas inactivas, Requirement: Escritura de Posts requiere autenticación, Requirement: Lectura pública restringida a contenido publicado en Pages, Requirement: Lectura pública restringida a contenido publicado en Posts, Requirement: Protección de datos sensibles de Users (+10 more)
