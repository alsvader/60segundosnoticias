...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_users_social_links_platform" AS ENUM('facebook', 'instagram', 'x', 'youtube', 'tiktok');
  CREATE TYPE "public"."enum_users_role" AS ENUM('admin', 'writer');
  CREATE TYPE "public"."enum_categories_color_theme" AS ENUM('red', 'blue', 'orange', 'green', 'pink', 'purple', 'cyan', 'yellow', 'teal', 'indigo');
  CREATE TYPE "public"."enum_categories_icon" AS ENUM('newspaper', 'video', 'plane', 'star', 'popcorn', 'dots');
  ...
  CREATE TYPE "public"."enum_pages_blocks_gallery_block_layout" AS ENUM('grid', 'carousel');
  CREATE TYPE "public"."enum_pages_blocks_video_block_provider" AS ENUM('youtube', 'vimeo', 'uploaded');
  CREATE TYPE "public"."enum_pages_blocks_banner_variant" AS ENUM('editorial', 'promotional', 'dark');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_gallery_block_layout" AS ENUM('grid', 'carousel');
  CREATE TYPE "public"."enum__pages_v_blocks_video_block_provider" AS ENUM('youtube', 'vimeo', 'uploaded');
  CREATE TYPE "public"."enum__pages_v_blocks_banner_variant" AS ENUM('editorial', 'promotional', 'dark');
  ...
  CREATE TABLE "categories" (
  	...
  	"description" varchar,
  	"color_theme" "enum_categories_color_theme",
  ...
  CREATE TABLE "pages_blocks_video_block" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"provider" "enum_pages_blocks_video_block_provider" DEFAULT 'youtube',
  	"url" varchar,
  	"video_id" integer,
  	"poster_id" integer,
  	"caption" varchar,
  ...
  CREATE TABLE "pages_blocks_banner" (
  	...
  	"link_label" varchar,
  	"link_u_r_l" varchar,
  	"variant" "enum_pages_blocks_banner_variant" DEFAULT 'editorial',
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_gallery_block" (
  	...
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"layout" "enum__pages_v_blocks_gallery_block_layout" DEFAULT 'grid',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_video_block" (
  	...
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"provider" "enum__pages_v_blocks_video_block_provider" DEFAULT 'youtube',
  	"url" varchar,
  	"video_id" integer,
  	"poster_id" integer,
  	"caption" varchar,
  ...
  CREATE TABLE "_pages_v_blocks_banner" (
  	...
  	"link_label" varchar,
  	"link_u_r_l" varchar,
  	"variant" "enum__pages_v_blocks_banner_variant" DEFAULT 'editorial',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  ALTER TABLE "categories" ADD CONSTRAINT "categories_seo_meta_image_id_media_id_fk" FOREIGN KEY ("seo_meta_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "categories_seo_seo_meta_image_idx" ON "categories" USING btree ("seo_meta_image_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_categories_color_theme";
  ...
  DROP TYPE "public"."enum_pages_blocks_video_block_provider";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_gallery_block_layout";
  DROP TYPE "public"."enum__pages_v_blocks_video_block_provider";
