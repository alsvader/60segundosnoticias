...
El sistema SHALL proveer un componente `Container` con un ancho máximo aproximado de 1360-1440px, centrado, y gutters responsivos (16-20px mobile, 24-32px tablet, 40-48px desktop). (Ref. AC-RESP-001, AC-RESP-002)
