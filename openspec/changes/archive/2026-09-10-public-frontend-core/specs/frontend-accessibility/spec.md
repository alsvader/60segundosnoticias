...
Los nuevos elementos interactivos del Header (trigger de menú móvil, items de navegación, enlaces del Footer) SHALL usar el mismo tratamiento de foco visible (`--ring`) y el mismo mínimo de touch target de 44px establecidos en Fase 4, sin un tratamiento de foco independiente o inconsistente.
