...
El sistema SHALL exponer una utilidad reutilizable para aplicar `paper-grain.webp` de forma muy sutil sobre el fondo `paper`, sin comprometer la legibilidad del texto.
...
- **THEN** consume la utilidad expuesta por este Design System con la opacidad definida, sin necesidad de reimplementar la textura
