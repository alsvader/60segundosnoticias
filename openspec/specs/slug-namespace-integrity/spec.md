...
Garantiza que los slugs de `Categories` y `Pages` no colisionen entre sí ni con rutas reservadas del sitio, protegiendo el namespace raíz compartido `/[slug]` sin todavía implementar generación automática de slugs.
